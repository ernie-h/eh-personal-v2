...
// var map = d3.select("#hk-map")
// // Create a scale: transform value in pixel
// var pixelize = d3.scaleLinear().domain([0, 100]).range([0, 400]);       // This is the corresponding value I want in Pixel

// map.append("circle").attr("cx", pixelize(10)).attr("cy", 160).attr("r", 5).style("fill", "red");
